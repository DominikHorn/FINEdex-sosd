...
class btree {
 ...
 private:
  ...
  struct inner_node : public node {
    ...
    inline void initialize(const unsigned short l) { node::initialize(l); }
 ...
 public:
  ...
  class value_compare {
   protected:
    ...
    inline value_compare(key_compare kc) : key_comp(kc) {}
 ...
 public:
  ...
  inline bool operator>(const btree_self& other) const { return other < *this; }
 ...
 private:
  ...
  struct result_t {
    ...
    inline result_t(result_flags_t f = btree_ok) : flags(f), lastkey() {}
